...
{			
	...
	Ephemeris::Ephemerisx6(fp_Bin, jd0, start + 100, nctr, r0, &inside, &Kep[start - 100][0], JD0[start - 100], 0); //начальные условия для перелета(скорость и положение)
...
int main()
{
	...
	double aa[] = { 0.7, 3.5 }, e[] = { -0.1, 0.4 }, I[] = { -15 / raddeg, 15 / raddeg }; //filters посмотреть в статье АиК
